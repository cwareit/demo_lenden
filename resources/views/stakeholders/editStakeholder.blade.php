...
@section('title')
    {{$currentStakeholder->name}} का व्यक्तिगत विवरणहरु सम्पादन गर्नुहोस
@endsection
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-6">
                <input 
                    ...
                    name="name" 
                    value="{{ old('name') ?? $currentStakeholder->name }}" 
                    autocomplete="off"
                >
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-6">
                <input 
                    ...
                    name="address" 
                    value="{{ old('address') ?? $currentStakeholder->address }}" 
                    autocomplete="off"
                >
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-6">
                <input 
                    ...
                    name="contact" 
                    value="{{ old('contact') ?? $currentStakeholder->contact }}" 
                    autocomplete="off"
                >
